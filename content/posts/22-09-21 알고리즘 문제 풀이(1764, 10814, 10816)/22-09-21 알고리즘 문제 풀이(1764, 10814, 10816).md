---
title: 22-09-21 알고리즘 문제 풀이(1764, 10814, 10816)
date: 2022-09-21
...
C++로 문제를 푼다면 std::sort 가 intro sort 이므로 직접 구현해야 할 것이다.<br/>
언어에 구애받지 않고 문제를 해결할수 있어야 진정한 실력자라고 생각한다.<br/>
아래는 그런 의미에서 직접 구현해본 병합정렬이다.
